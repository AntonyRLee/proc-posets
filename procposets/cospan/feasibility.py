"""Integer feasibility for leg-multiplicity constraint systems.
    ...
    for d in domains:
        ...
        if size > max_assignments:
            raise FeasibilityTooLarge(
                ...
                "raise max_assignments, lower the bound, or pass an ILP solver"
            )
...
def all_solutions(
    ...
    (the **unroller** backend). Unlike :func:`ranges` -- which reports each
