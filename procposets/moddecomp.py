...
algorithms in the literature do NOT
...
References: McConnell & Spinrad 1999 (with transitive orientation) and
...
and any asymptotic claim rests on the literature algorithms above, not on this file.
"""
